...
//
    ...
    .controller('EditMenuCtrl', ['$scope', '$firebase', 'syncData' ,function($scope, $firebase, syncData) {
        ...
        $scope.colors = ['red', 'green','purple','orange','yellow','blue','white'];
        $scope.icons = ['fa fa-ambulance','fa fa-apple','fa fa-frown-o','fa fa-heart-o','fa fa-hand-o-right ','fa fa-krw','fa fa-magic','fa fa-pagelines','fa fa-star','fa fa-trophy','fa fa-anchor','fa  fa-bolt ','fa fa-eye','fa fa-fighter-jet','fa fa-lemon-o','fa fa-music','fa fa-thumbs-o-up','fa fa-beer','fa fa-cutlery','fa fa-fire','fa fa-gamepad','fa fa-sun-o','fa fa-try','fa fa-pinterest-square'];
...
//
    ...
    .controller('OrderCtrl', ['$scope', '$firebase', 'FBURL','syncData', '$modal', '$log', 'firebaseRef', function($scope, $firebase, FBURL, syncData, $modal, $log, firebaseRef)
    {
        ...
        $scope.addOrder = function()
        {
            ...
            else if($scope.sms && $scope.phone.length != 10)
            {
                alert("Please enter a 10 digit phone number for the customer.")
            }
            else
            {
